...
export default class GLTFBuilder extends GLBBuilder {
  constructor() {
    ...
    super(options); // Soft dependency on DRACO, app needs to import and supply these
  ...
  addCompressedMesh(attributes, indices) {
    ...
    const compressedData = dracoEncoder.encodeMesh(attributes); // Draco compression may change the order and number of vertices in a mesh.
