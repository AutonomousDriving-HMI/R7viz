  ...
  (0, _createClass2.default)(GLBBuilder, [{
    ...
    value: function addBuffer(sourceBuffer) {
      ...
      var accessorDefaults = {
        size: accessor.size,
        componentType: (0, _core.getComponentTypeFromArray)(sourceBuffer),
    ...
    value: function addAccessor(bufferViewIndex, accessor) {
      ...
      this.json.accessors.push({
        ...
        type: (0, _core.getAccessorTypeFromSize)(accessor.size),
    ...
    value: function _createGLBBuffer() {
      ...
      var fileLength = binChunkOffset + GLB_CHUNK_HEADER_SIZE + (0, _core.padTo4Bytes)(binChunk.byteLength); // Length is know, we can create the GLB memory buffer!
      ...
      (0, _core.copyArrayBuffer)(glbArrayBuffer, jsonChunk, jsonChunkOffset); // TODO - Add spaces as padding to ensure scene is a multiple of 4 bytes.
