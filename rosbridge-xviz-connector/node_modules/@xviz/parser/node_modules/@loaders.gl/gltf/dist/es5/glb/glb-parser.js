...
/*#__PURE__*/
function () {
  (0, _createClass2.default)(GLBParser, null, [{
    key: "isGLB",
  ...
  (0, _createClass2.default)(GLBParser, [{
    ...
    value: function _parse(options) {
      ...
      this.unpackedBuffers = (0, _unpackGlbBuffers.default)(this.glbArrayBuffer, this.json, this.binaryByteOffset);
      this.json = (0, _unpackBinaryJson.default)(this.json, this.unpackedBuffers);
    }
  }, {
    key: "_parseBinary",
    value: function _parseBinary(options) {
      ...
      (0, _core.assert)(version === 2, "Invalid GLB version ".concat(version, ". Only .glb v2 supported"));
      (0, _core.assert)(fileLength > 20); // Write the JSON chunk
      ...
      (0, _core.assert)(valid, "JSON chunk format ".concat(jsonChunkFormat)); // Create a "view" of the binary encoded JSON data
      ...
      var binaryChunkStart = jsonChunkOffset + (0, _core.padTo4Bytes)(jsonChunkLength);
      ...
      (0, _core.assert)(valid, "BIN chunk format ".concat(binChunkFormat));
      return {
