...
export var isPromise = function isPromise(x) {
  return x && (_typeof(x) === 'object' || typeof x === 'function') && typeof x.then === 'function';
};
...
function _forEach() {
  _forEach = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee5(iterator, visitor) {
...
function _concatenateAsyncIterator() {
  _concatenateAsyncIterator = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee6(asyncIterator) {
...
function _textDecoderAsyncIterator() {
  _textDecoderAsyncIterator = _wrapAsyncGenerator(
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee(arrayBufferIterator, options) {
...
function _textEncoderAsyncIterator() {
  _textEncoderAsyncIterator = _wrapAsyncGenerator(
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee2(textIterator, options) {
...
function _lineAsyncIterator() {
  _lineAsyncIterator = _wrapAsyncGenerator(
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee3(textIterator) {
...
function _numberedLineAsyncIterator() {
  _numberedLineAsyncIterator = _wrapAsyncGenerator(
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee4(lineIterator) {
