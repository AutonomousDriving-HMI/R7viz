...
export const isPromise = x => x && (typeof x === 'object' || typeof x === 'function') && typeof x.then === 'function';
export const isIterable = x => x && typeof x[Symbol.iterator] === 'function';
export const isAsyncIterable = x => x && typeof x[Symbol.asyncIterator] === 'function'; // GENERAL UTILITIES
