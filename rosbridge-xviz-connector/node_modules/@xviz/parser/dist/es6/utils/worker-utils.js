...
class WorkerThread {
  ...
  process(data) {
    ...
    return new Promise((resolve, reject) => {
      worker.onmessage = e => {
        this.isBusy = false; // console.log(e.data._size, `${Date.now() - e.data._sentAt}ms`);
...
export class WorkerFarm {
  ...
  constructor(_ref2) {
    let workerURL = _ref2.workerURL,
        ...
        debug = _ref2$debug === void 0 ? () => {} : _ref2$debug,
  ...
  broadcast(data) {
    const count = this.workers.length; // queue in reverse order as bias worker searching in getAvailableWorker()
