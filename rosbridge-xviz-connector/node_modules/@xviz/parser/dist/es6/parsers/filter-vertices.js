...
import { getXVIZConfig } from '../config/xviz-config'; // filter out identical vertices from a list
...
function getPointAtIndex(vertices, i) {
  let isFlatArray = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  let point = null;
