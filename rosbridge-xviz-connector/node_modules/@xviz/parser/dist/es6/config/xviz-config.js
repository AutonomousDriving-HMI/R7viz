...
XVIZObject.setDefaultCollection(new XVIZObjectCollection()); // Allow subscribing to XVIZConfig changes

const subscribers = []; // func is a function that takes no arguments
