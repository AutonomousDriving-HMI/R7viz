...
exports.getWorkerFarm = getWorkerFarm;
exports.destroyWorkerFarm = destroyWorkerFarm;
exports.initializeWorkerFarm = initializeWorkerFarm;
exports.updateWorkerXVIZVersion = updateWorkerXVIZVersion;
...
function initializeWorkerFarm(_ref) {
  ...
  if (!workerFarm) {
    ...
    workerFarm = new _workerUtils.WorkerFarm({
      workerURL: workerURL,
...
(0, _xvizConfig.subscribeXVIZConfigChange)(updateWorkerXVIZVersion);
