...
exports.normalizeXVIZPrimitive = normalizeXVIZPrimitive;
exports.PRIMITIVE_CAT = void 0;
...
exports.PRIMITIVE_CAT = PRIMITIVE_CAT;

function normalizeXVIZPrimitive(PRIMITIVE_PROCCESSOR, primitive, objectIndex, streamName, type, time, postProcessPrimitive) {
  ...
  var _PRIMITIVE_PROCCESSOR = PRIMITIVE_PROCCESSOR[primitiveType],
      ...
      normalize = _PRIMITIVE_PROCCESSOR.normalize; // Apply a small offset to 2d geometries to battle z fighting
