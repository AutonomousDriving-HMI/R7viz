    ...
    value: function process(data) {
      ...
      return new Promise(function (resolve, reject) {
        worker.onmessage = function (e) {
          _this.isBusy = false; // console.log(e.data._size, `${Date.now() - e.data._sentAt}ms`);
...
function () {
  ...
  _createClass(WorkerFarm, [{
    ...
    value: function broadcast(data) {
      var count = this.workers.length; // queue in reverse order as bias worker searching in getAvailableWorker()
