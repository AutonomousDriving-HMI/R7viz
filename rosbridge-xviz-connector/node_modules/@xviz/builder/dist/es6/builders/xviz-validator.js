...
export default class XVIZValidator {
  constructor(_ref) {
    let validateError = _ref.validateError,
  ...
  matchMetadata(builder) {
    ...
    if (metadata && metadata.streams) {
      ...
      if (!streamMetadata) {
        ...
        this._validateWarn(`Stream ${streamId} category '${category}' does not match metadata definition (${streamMetadata.category}).`);
      }
    }
  }
  ...
  validateStyle(builder) {
    ...
    if (validProperties) {
      ...
      this.warn(this, `Missing style validations for stream ${streamId} with type ${builder._type}`);
    }
  }
