...
import { DracoEncoder, DracoDecoder } from '@loaders.gl/draco'; // 0-frame is an index file for timestamp metadata
...
function () {
  function XVIZWriter() {
    ...
    var _options$dataSink = options.dataSink,
        ...
        _options$draco = options.draco,
        draco = _options$draco === void 0 ? false : _options$draco;
    this.sink = dataSink;
    this.frameTimings = {
      frames: new Map()
    };
