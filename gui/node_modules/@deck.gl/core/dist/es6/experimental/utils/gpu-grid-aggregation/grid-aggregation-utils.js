...
export function pointToDensityGridData(_ref) {
  let data = _ref.data,
      ...
      getWeight = _ref$getWeight === void 0 ? d => [1.0, 0, 0] : _ref$getWeight,
      _ref$fp = _ref.fp64,
...
function parseGridData(data, getPosition) {
  let getWeight = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  ...
  for (let p = 0; p < data.length; p++) {
    ...
    let weight = getWeight ? getWeight(data[p]) : [1.0, 0, 0]; // Aggregator expects each weight is an array of size 3
