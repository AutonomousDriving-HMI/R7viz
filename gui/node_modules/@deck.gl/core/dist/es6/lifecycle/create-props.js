...
export function createProps() {
  ...
  const propsPrototype = propTypeDefs.defaultProps; // Create a new prop object with default props object in prototype chain
...
function createPropsPrototypeAndTypes(componentClass) {
  ...
  const defaultProps = createPropsPrototype(componentPropDefs.defaultProps, parentPropDefs && parentPropDefs.defaultProps, propTypes, componentClass); // Create a map for prop whose default value is a callback

  const deprecatedProps = Object.assign({}, parentPropDefs && parentPropDefs.deprecatedProps, componentPropDefs.deprecatedProps); // Store the precalculated props
