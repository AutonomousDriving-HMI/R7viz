...
function connectToLog(_ref) {
  ...
  function (_PureComponent) {
    ...
    function WrappedComponent() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_update", function (logVersion) {
        _this.setState({
    ...
    _createClass(WrappedComponent, [{
      ...
      value: function render() {
        ...
        return _react.default.createElement(Component, _extends({}, otherProps, logState, {
          log: log
        }));
      }
    }]);
