...
function (_XVIZLoaderInterface) {
  ...
  function XVIZFileLoader(options) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onMessage", function (message) {
      switch (message.type) {
        case _parser.LOG_STREAM_MESSAGE.METADATA:
          _this.set('logSynchronizer', new _parser.StreamSynchronizer(_this.streamBuffer));
        ...
        case _parser.LOG_STREAM_MESSAGE.TIMESLICE:
          ...
          if (_this.streamBuffer.valueOf() !== oldVersion) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onError", function (error) {
  ...
  _createClass(XVIZFileLoader, [{
    ...
    value: function connect() {
      ...
      this._loadTimings().then(function (data) {
        ...
        _this2._loadMetadata().then(function () {
          return _this2._loadNextBatch(1);
        });
      });
    }
  }, {
    ...
    key: "_loadNextBatch",
    value: function _loadNextBatch(startFrame) {
      var _this3 = this;
      ...
      for (var i = 0; i < this._batchSize && startFrame + i < this._numberOfFrames; i++) {
        var filePath = this._getFilePath(startFrame + i);
      ...
      Promise.all(promises.filter(Boolean)).then(function () {
        _this3._loadNextBatch(startFrame + _this3._batchSize);
      });
    }
  }, {
    key: "_loadFile",
      ...
      return file.then(function (data) {
        ...
        if (_this4._isOpen) {
          (0, _parser.parseStreamMessage)({
            message: data,
            onResult: _this4._onMessage,
            onError: _this4._onError,
