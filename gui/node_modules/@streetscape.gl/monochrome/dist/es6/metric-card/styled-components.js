...
export const CardContainer = styled.div(props => _objectSpread({}, props.theme.__reset__, {
  position: 'relative',
  fontSize: props.theme.fontSize
}, evaluateStyle(props.userStyle, props)));
export const CardTitle = styled.div(props => _objectSpread({
  textAlign: 'center',
  fontWeight: 200,
  fontSize: '1.6em',
  maxWidth: '100%',
...
export const ErrorMessage = styled.div(props => _objectSpread({
  fontWeight: 'bold',
  textAlign: 'center',
  margin: props.theme.spacingNormal,
  color: props.theme.textColorError
}, evaluateStyle(props.userStyle, props))); // react-vis styles

/* Adpated from react-vis/dist/styles/plot.scss */

export const ChartContainer = styled.div(props => _objectSpread({}, props.theme.__reset__, {
  cursor: 'pointer',
...
export const CrosshairItemTitle = styled.span(props => _objectSpread({
  fontWeight: 'bold',
  marginRight: props.theme.spacingTiny
}, evaluateStyle(props.userStyle, props)));
export const CrosshairItemValue = styled.span(props => _objectSpread({
  span: {
...
export const FilterContainer = styled.div(props => _objectSpread({}, props.theme.__reset__, {
  position: 'relative',
  paddingLeft: props.theme.spacingLarge,
  fontSize: props.theme.fontSize
}, evaluateStyle(props.userStyle, props)));
export const FilterToggle = styled.div(props => _objectSpread({
  position: 'absolute',
  left: 0,
  cursor: 'pointer',
  fontWeight: 'bold',
...
export const FilterItem = styled.div(props => _objectSpread({
  display: 'flex',
  alignItems: 'center',
  cursor: 'pointer',
...
export const FilterLegend = styled.div(props => _objectSpread({
