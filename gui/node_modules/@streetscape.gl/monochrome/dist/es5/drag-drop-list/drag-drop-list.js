...
function (_PureComponent) {
  ...
  function DragDropList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onDragStart", function (targetItem) {
      var items = _this.props.items; // Update bounding boxes
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onDragMove", function (pos) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onDragEnd", function (pos) {
