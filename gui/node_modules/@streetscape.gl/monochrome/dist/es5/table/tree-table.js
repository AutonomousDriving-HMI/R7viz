...
_defineProperty(TreeTable, "propTypes", _objectSpread({}, _table.Table.propTypes, {
  indentSize: _propTypes.default.number
}));

_defineProperty(TreeTable, "defaultProps", _objectSpread({}, _table.Table.defaultProps, {
  indentSize: 12
}));
