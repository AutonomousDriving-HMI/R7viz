...
function (_PureComponent) {
  ...
  function Slider() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_updateValue", function (offsetX, width) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onDrag", function (evt) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(SliderWrapper, _extends({}, styleProps, {
      ...
      }, _react.default.createElement(SliderTrack, _extends({
        userStyle: style.track
      }, styleProps, {
        ref: function ref(_ref) {
          _this2._track = _ref;
        }
      }), children, _react.default.createElement(SliderTrackFill, _extends({}, styleProps, {
        userStyle: style.trackFill,
        style: {
          width: "".concat(ratio * 100, "%")
        }
      })), _react.default.createElement(SliderKnob, _extends({}, styleProps, {
