...
function isJSON(encodedString) {
  var firstChar = String.fromCharCode(encodedString[0]);
  var lastChar = String.fromCharCode(encodedString[encodedString.length - 1]);
...
function decode(data, recursive) {
  if (!data) {// ignore
    ...
    var jsonString = new TextDecoder('utf8').decode(data);
    return JSON.parse(jsonString);
  } else if (recursive && _typeof(data) === 'object') {
    for (var key in data) {
