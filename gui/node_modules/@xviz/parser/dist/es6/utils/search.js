...
export function findInsertPos(timeslices, timestamp) {
  let insertPosition = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : INSERT_POSITION.LEFT;
  let timestampAccessor = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : defaultTimestampAccessor;
