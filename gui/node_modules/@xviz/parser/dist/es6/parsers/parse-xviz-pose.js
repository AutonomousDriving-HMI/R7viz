...
export function parseXVIZPose(pose) {
  const mapOrigin = pose.mapOrigin,
  ...
  if (mapOrigin) {
    const longitude = mapOrigin.longitude,
  ...
  if (position) {
    const _position = _slicedToArray(position, 3),
          x = _position[0],
          y = _position[1],
          z = _position[2];
  ...
  if (orientation) {
    const _orientation = _slicedToArray(orientation, 3),
          roll = _orientation[0],
