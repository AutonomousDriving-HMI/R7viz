...
const getCurrentLogSliceMemoized = memoize(function (streamFilter, lookAheadMs) {
...
export default class BaseSynchronizer {
  ...
  getLogSlice(streamFilter) {
    ...
    return getCurrentLogSliceMemoized(streamFilter, this.lookAheadMs, ...this._streamsByReverseTime);
