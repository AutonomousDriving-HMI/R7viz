...
_xvizObject.default.setDefaultCollection(new _xvizObjectCollection.default()); // Allow subscribing to XVIZConfig changes


var subscribers = []; // func is a function that takes no arguments
