...
var getCurrentLogSliceMemoized = (0, _memoize.default)(function (streamFilter, lookAheadMs) {
  _stats.default.bump('getCurrentLogSliceMemoized');
  ...
  return new _logSlice.default(streamFilter, lookAheadMs, streamsByReverseTime);
});
...
function () {
  ...
  _createClass(BaseSynchronizer, [{
    ...
    value: function getCurrentFrame(streamFilter, trackedObjectId) {
      _stats.default.bump('getCurrentFrame');
      ...
      var vehiclePose = logSlice.getStream(PRIMARY_POSE_STREAM, null);

      if (vehiclePose !== this._lastVehiclePose) {
        _stats.default.bump('vehiclePose');
    ...
    value: function setTime(time) {
      var _getXVIZConfig2 = (0, _xvizConfig.getXVIZConfig)(),
          PLAYBACK_FRAME_RATE = _getXVIZConfig2.PLAYBACK_FRAME_RATE;
    ...
    value: function getLogSlice(streamFilter) {
      ...
      var _getXVIZConfig3 = (0, _xvizConfig.getXVIZConfig)(),
          TIME_WINDOW = _getXVIZConfig3.TIME_WINDOW;

      this._lastLoResTime = this.loResTime;
      this._streamsByReverseTime = this._getTimeRangeInReverse(this.loResTime - TIME_WINDOW, this.loResTime);

      _stats.default.bump('geometry-refresh');
